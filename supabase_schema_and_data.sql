...
VALUES ('main_store', '{"users":[],"transactions":[],"tags":[],"rules":[],"documents":[],"investments":[],"settings":{"categories":["Housing","Groceries","Shopping","Dining","Transportation","Utilities","Subscriptions","Insurance","Health","Entertainment","Income","Needs review","Other"],"accounts":["Main Checking","Everyday Visa","Rewards Card","Cash"],"goals":[],"budgets":[],"subscriptions":[],"recurring":[],"dismissedPatterns":[],"assets":0,"liabilities":0,"netWorthConfigured":false,"selectedPeriod":"all-time","driveFolder":{"name":"Kuberis Financial Inbox","id":"folder-kuberis-inbox-01","url":"https://drive.google.com/drive/my-drive"},"driveSync":{"schedule":"08:00 AM Daily","timezone":"Asia/Kolkata","lastSyncedAt":null,"lastStatus":"idle","lastImportedCount":0,"lastDuplicateCount":0,"lastReviewCount":0,"errors":[]},"processedDriveFileIds":[],"driveResetAt":null,"freshStart":true},"userSettings":{}}'::jsonb, NOW())
